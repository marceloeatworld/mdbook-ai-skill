...
<!-- repo: rust-lang/mdBook commit a57975d (2026-09-03 12:41:46 +0000) -->
...
- **zoomable-images:** If `true`, when clicking on images, it will open a modal with an expanded view of the image. Default is `true`.
